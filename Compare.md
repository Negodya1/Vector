...
Онлайновый векторный графический редактор. Его можно использовать как веб-приложение, или в виде онлайнового сервиса. Используется для создания и редактирования файлов в формате SVG и некоторых других форматов. Программа написана на JavaScript
### Преимущества:
...
## Inkscape
![Inkscape](/Images/Inkscape.jpg)
Inkscape является специальной программой, которая разработана для создания и обработки технических иллюстраций. В основном ее применяют для изготовления визиток, плакатов, схем, логотипов и графиков.
### Преимущества:
- обширный инструментарий
- Inkscape оснащена собственным движком рендеринга
- приложение поддерживается операционными системами Windows и Linux
### Недостатки:
- плохая оптимизация
## BoxySVG
![BoxySVG](/Images/BoxySVG.png)
Онлайн редактор векторной графики. Работа со слоями, большой инструментарий (у некоторых инструментов не было аналогов в предыдущих программах)
### Преимущества:
- большой инструментарий
- хорошая оптимизация
- экспорт в различные форматы
...
- кроссплатформа
### Недостатки:
- отсутсвует локализация на русский язык
- сохранение на облако доступно только по подписке
- только онлайн версия
